...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    .delete-btn{background:var(--danger);color:white;padding:6px 12px;text-decoration:none;
    ...
    <table>
      ...
      if (file_exists($csvFile)) {
          ...
          foreach ($rows as $index => $row) {
              ...
              // ✅ Fixed the delete link here
              echo "<td><a class='delete-btn' href='delete.php?index=$index' onclick=\"return confirm('Are you sure you want to delete this record?');\">Delete</a></td>";
              echo "</tr>";
          }
      } else {
